...
import { HERO_SLIDES } from "../constants"; // ensure this path is valid
  ...
  return (
    <>
      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Hotel",
            name: "Hush and Bloom",
            url: "https://www.hushandbloom.com",
            logo: "https://www.hushandbloom.com/Logo.png", // Replace with actual logo
            description:
              "Luxury hotel toiletries supplier in India — offering high-quality custom shampoos, conditioners, and hospitality products.",
            address: {
              "@type": "PostalAddress",
              addressCountry: "IN",
            },
            ...
            sameAs: [
              "https://www.instagram.com/hushandbloom", // Replace with your links
              "https://www.facebook.com/hushandbloom",
            ],
          })}
        </script>
      </Helmet>
      ...
      >
        ...
        {/* 🕵️‍♂️ Hidden SEO content (for Google indexing) */}
        <div style={{ display: "none" }} aria-hidden="true">
          <h2>Premium Hotel Amenities Supplier in India</h2>
          <p>
            We provide top-quality shampoo, conditioner, and dry items for
            hotels across India. Our products are designed for luxury
            hospitality experiences, custom branding, and eco-friendly comfort.
          </p>
          <ul>
            ...
            <li>Custom labeled hotel shampoo and conditioner</li>
            <li>Guest room essentials with premium packaging</li>
          </ul>
        </div>
      </section>
    </>
